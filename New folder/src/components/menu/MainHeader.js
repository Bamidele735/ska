...
const Header = function ({ navSelected, setIsOpen }) {
  ...
  return (
    <div className='text-gray-100 flex justify-between' style={{ height: '76px' }}>
      <div className='flex justify-between z-index-9 p-3'>
        <a href="https://greatdaneai.com/" >
                  ...
                  pending ? (
                    ...
                    <div className="flex gap-3">
                      {/* <div className='flex justify-center align-items-center gap-3 mt-2 cursor-pointer' onClick={addTokenCallback}>
                        ...
                        <span className='fs-14'> {isMobile ? 'FXT' : 'Add FXT token to MetaMask'}</span>
                      </div> */}
